...
class ImageViewerGUI:
    ...
    def create_widgets(self):
        ...
        self.progress_label = ttk.Label(main_frame, text="0 of 0", font=("Arial", 10))
        ...
        ### ZOOMING Option ####
        self.image_label.bind("<MouseWheel>", self.zoom_image)  # For Windows
    ...
    def zoom_image(self, event):
        '''
        This function is used to Zoom in and out of an image
        '''
        ...
        self.zoom_scale = max(0.1, min(self.zoom_scale, 5.0))  # Clamp zoom level
        self.display_current_image()  # Redraw image at new zoom
    ...
    def start_viewing(self):
        ...
        self.progress_label.config(text=f"0 of {len(self.image_paths)} images") ### For Progress Bar
    ...
    def display_current_image(self):
        ...
        self.img_path = self.image_paths[self.current_index] ##TODO: Check this line
        ...
        ### For Progress Bar
        self.progress["value"] = (self.current_index + 1) / len(self.image_paths) * 100
        self.progress_label.config(text=f"{self.current_index + 1} of {len(self.image_paths)} images")
